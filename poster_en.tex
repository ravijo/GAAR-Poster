...
\begin{poster}{
	...
	\headerbox{Estimation of Hand location in 3D space}{name=estimation,column=1,below=rcm,span=1}{
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\node at (a.east)[anchor=center, xshift=60mm, yshift=0mm]{\includegraphics[width=0.3\textwidth]{wrist_detection_output}};
	...
	\headerbox{Conclusion}{name=conclusion,column=1,below=estimation,span=1}{
		\begin{boenumerate}\compresslist
			...
			\item Real-time tracking of mannequin is required for making approach more robust
